...
class Ui_AuthenticationDialog(object):
    ...
    def retranslateUi(self, AuthenticationDialog):
        ...
        AuthenticationDialog.setWindowTitle(_translate("AuthenticationDialog", "登录"))
        self.infoLabel.setText(_translate("AuthenticationDialog", "新鑫海航线运管系统"))
        ...
        self.saveCheckBox.setText(_translate("AuthenticationDialog", "保存用户名"))
