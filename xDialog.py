...
class InputDialog(wx.Dialog):
    ...
    def InitUI(self):
        ...
        font = wx.Font(13, wx.DEFAULT, wx.NORMAL, wx.NORMAL, True)
        ...
        sureButton = wx.Button(panel, -1, u'登录', pos=(20, 120), size=(120, 40))
        ...
        cancleButton = wx.Button(panel, -1, u'取消', pos=(160, 120), size=(120, 40))
